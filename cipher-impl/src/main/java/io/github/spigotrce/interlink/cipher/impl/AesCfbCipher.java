package io.github.spigotrce.interlink.cipher.impl;

import io.github.spigotrce.interlink.cipher.Cipher;
...
/**
 * An AES cipher in CFB mode with PKCS#5 padding.
 *
 ...
 * Do not rely on this cipher over an untrusted network. A signing layer (e.g. an HMAC or GCM) must
 ...
 */
public final class AesCfbCipher implements Cipher {
  ...
  private static javax.crypto.Cipher newCipher() {
    try {
      return javax.crypto.Cipher.getInstance("AES/CFB/PKCS5Padding");
